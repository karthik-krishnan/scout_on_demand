...
module Formatters
  class FormatAmount < Format
    ...
    def from(value, options = {})
      ccy_code = "<span class='tiny'>#{value.currency.code}</span>"
      ccy_symbol = "<span class='tiny'>#{value.currency.symbol}</span>"
      parenthesis = false
      ...
      formatted_amount = number_to_currency(value, :unit => '', :precision => precision)
