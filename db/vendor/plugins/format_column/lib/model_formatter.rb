...
module ModelFormatter # :nodoc:
  ...
  module ClassMethods
    ...
    def format_column(attr, options={}, &fmt_block)
      ...
      attr_fmt_options_accessor = "#{my_options[:attr]}_formatting_options".to_sym
      ...
      metaclass.class_eval do
        ...
        define_method attr_formatter_method do |value, *args|
          return value if value.nil?
          from_method = my_options[:formatter].method(:from)
          my_options[:options].merge!({:model => args.first}) if args.size > 0
          from_method.call(value, my_options)
        end
      ...
      define_method my_options[:formatted_attr] do ||
        ...
        self.class.send attr_formatter_method, value, self
      end
